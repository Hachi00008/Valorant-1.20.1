...
# タグの変更
    execute if score $AttackerSide GameCore matches 0 run function game_core:game_tick/battle_phase/attack_swap/red
    execute if score $AttackerSide GameCore matches 1 run function game_core:game_tick/battle_phase/attack_swap/blue
